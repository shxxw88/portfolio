  ...
  const projects = [
    {
      id: 1,
      title: 'Scaffold',
      description: 'Reducing financial barriers to trades training by aggregating fragmented grant databases and matching BC apprentices to relevant funding opportunities.',
